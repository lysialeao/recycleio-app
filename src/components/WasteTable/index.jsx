...
export const WasteTable = () => {
  ...
  const { userWastesFormatted } = useContext(WasteContext)
  ...
  return (
    <DataTable value={userWastesFormatted} editMode="row" dataKey="id" onRowEditComplete={() => {}} tableStyle={{ minWidth: '50rem' }}>
